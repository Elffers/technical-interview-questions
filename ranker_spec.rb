...
describe Ranker do
  ...
  context 'score' do
    it 'scores the teams correctly' do
      ranker.score
  ...
  context 'rank' do
    it 'returns an array of arrays grouped by score' do
      expect(ranker.rank).to eq [[1, ["Ravens", "Cowboys", "Patriots"]], [4, ["Broncos"]], [9, ["Seahawks"]]]
    end
  end
